...
export default function Updatetasks() {
    ...
    const { updatetasks } = useLocalSearchParams(); // this is the ID from the URL

    // Find the task from your array
    const task = taskData.find(t => t._id.toString() === updatetasks);
    console.log(task)
            ...
            <View style={styles.container}>
                ...
                <View style={""}>
                    <View style={styles.formContainer}>
                        ...
                        {/* submit button */}
                        <TouchableOpacity style={styles.button} onPress={handleUpdateTask} disabled={isLoading} >
                            {
                                isLoading ? (
